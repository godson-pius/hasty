...
Tags: autoblog, news aggregator, content curation, rss, feed, rss feed to post, syndication, multiple feed import, full text rss, translator, wordai, spinnerchief, spinrewriter, the best spinner
...
* Spin post content with [WordAI](http://www.cyberseo.net/partners/wordai.php), [SpinnerChief](http://www.cyberseo.net/partners/spinnerchief.php), [SpinRewriter](http://www.cyberseo.net/partners/spinrewriter.php) and [TBS](http://www.cyberseo.net/partners/tbs.php) 3rd-party services*.
* Use the Full Text RSS extractor to import full-text articles from shortened RSS feeds. This feature is based on freeware GPL library by fivefilters.org. This built-in feature works right out of the box. No 3rd-party services or paid API keys.
...
> * Take advantage of the additional 3rd-party content spinners, such as [X-Spinner](https://www.cyberseo.net/partners/x-spinner.php), [Espinner](https://www.cyberseo.net/partners/espinner.php) and [ChimpRewriter](https://www.cyberseo.net/partners/spinchimp.php).
...
> * Use [post templates](http://www.cyberseo.net/content-syndicator/#templates) to define layouts for auto-generated posts and pages.
...
> * Use [Article Forge](https://www.cyberseo.net/partners/articleforge.php) service automatically generate completely unique, on-topic, high-quality articles.
...
>
> **[Learn more about CyberSEO Pro](http://www.cyberseo.net/)**
...
= 6.31 =
* "Keep downloaded images" improved.

= 6.30 =
* A new "Keep downloaded images" General Settings option added. It prevents the plugin from removing of downloaded and attached images on post deletion.

= 6.29 =
* Bug fix.

= 6.28 =
* Fully compatible with WordPress 5.7.

= 6.27 =
* Fully compatible with PHP 7.4.

= 6.26 =
* Now the plugin tries to pull the feed w/o a user agent and if failed, pretends to be a Google bot.

= 6.25 =
* If a post has no title, it (the title) will be generated from the post's body.
* Fully compatible with WordPress 5.6.

= 6.24 =
* CyberSEO Lite script hides itself from search engines and redirects to 404 is opened in browser outside of WordPress.

= 6.23 =
* The image download algorithm has been improved.

= 6.22 =
* New Vimeo RSS feed format is now supported.
...
= 6.19 =
* Now compatible with the new IGN RSS feed format.
* Full Text RSS has been updated.
* Fully compatible with WordPress 5.3.2.

= 6.18 =
* Chinese language is now available in Yandex Transalte.
* Fully compatible with WordPress 5.3.2.
